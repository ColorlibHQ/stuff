...
class Stuff_Post_Parser {
	/**
	 * Stuff_Post_Parser constructor.
	 *
	 * @param string $option
	 */
	...
	/**
	 * @return Stuff_Post_Parser
	 */
	public static function get_instance() {
		static $inst;
		if ( ! $inst ) {
			$inst = new Stuff_Post_Parser();
		}
	 ...
	 * @return string
	 */
	public function parse_stuff_team_members( $control, $value, $id ) {
		$content = '';
		$content .= '<!-- epsilon/' . $id . ' -->' . "\n";
	 ...
	 * @return string
	 */
	public function parse_stuff_expertise( $control, $value, $id ) {
		$content = '';
		$content .= '<!-- epsilon/' . $id . ' -->' . "\n";
	 ...
	 * @return string
	 */
	public function parse_stuff_services( $control, $value, $id ) {
		$content = '';
		$content .= '<!-- epsilon/' . $id . ' -->' . "\n";
	 ...
	 * @return string
	 */
	public function parse_stuff_testimonials( $control, $value, $id ) {
		$content = '';
		$content .= '<!-- epsilon/' . $id . ' -->' . "\n";
	 ...
	 * @return string
	 */
	public function parse_stuff_portfolio( $control, $value, $id ) {
		$content = '';
		$content .= '<!-- epsilon/' . $id . ' -->' . "\n";
	 ...
	 * @return string
	 */
	public function parse_stuff_price_boxes( $control, $value, $id ) {
		$content = '';
		$content .= '<!-- epsilon/' . $id . ' -->' . "\n";
		...
		foreach ( $value as $item ) {
			...
			if ( ! empty( $item['price_box_url'] ) ) {
				$content .= '<a href="' . $item['price_box_url'] . '">' . esc_html__( 'Purchase', 'stuff' ) . '</a>' . "\n";
			}
	 ...
	 * @return string
	 */
	public function parse_stuff_slides( $control, $value, $id ) {
		$content = '';
		$content .= '<!-- epsilon/' . $id . ' -->' . "\n";
		if ( ! empty( $value ) ) {
